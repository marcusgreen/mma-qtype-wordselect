...
/**
 * This is the class for wordselect question rendering.
 *
 * @module mm.addons.qtype_wordselect
 * @ngdoc service
 * @name $mmaQtypeWordselectRender
 */
.factory('$mmaQtypeWordselectRender', function($mmUtil, $timeout) {
    var self = {};
    ...
    function question_instance(question, readonly, inputIds) {
        ...
        this.css_selectors = function(slot) {
            var topnode = "#mma-mod_quiz-question-" + slot + ' .mma-qtype-wordselect-container';
            return {
                top_node : function() {
                    return topnode;
                },
        ...
        this.position_drag_item = function (drag) {
            ...
            if (!placeno) {
                ...
                // Drop position.
                position = $mmUtil.getElementXY(document, this.selectors.drop_for_place(placeno), 'mma-qtype-wordselect-container');
